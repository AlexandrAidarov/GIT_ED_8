...
public class RequestsNote {

    private Set<NoteBoocks> notebooks = new HashSet<>();
    private List<Criterion> criterionList = new ArrayList<>();
    private static Scanner scanner = new Scanner(System.in);

    public void printList(){
        for (NoteBoocks notebook : notebooks){
    ...
    public boolean notebookIsCorrect(NoteBoocks notebook){
    ...
    public RequestsNote(Set<NoteBoocks> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public RequestsNote(Set<NoteBoocks> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
